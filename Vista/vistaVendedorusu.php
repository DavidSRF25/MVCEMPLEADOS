...
<nav>
    <div class="navbar">
      ...
      <ul class="menu">
            ...
            <li><a href="VendedorUsu.php">Usuario</a></li>
            <li><a href="VENDEDOR.php">Empleado</a></li>
                    ...
                    foreach ($datos as $f) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <input type="hidden" value="<?php echo $f[0]; ?>" name="criterio">
                                    <input disabled type="submit" onclick="return ConfirmDelete()" class="eliminar" value="Borrar" name="borrar" >
                                </form>
                            </td>
